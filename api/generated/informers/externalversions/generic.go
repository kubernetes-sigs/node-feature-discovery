...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("workerconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Nfd().V1alpha1().WorkerConfigs().Informer()}, nil
