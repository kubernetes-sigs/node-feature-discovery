...
require (
	...
	k8s.io/pod-security-admission v0.30.11
...
require (
	...
	k8s.io/component-helpers v0.30.11 // indirect
	k8s.io/controller-manager v0.30.11 // indirect
	k8s.io/csi-translation-lib v0.30.11 // indirect
	k8s.io/dynamic-resource-allocation v0.30.11 // indirect
