...
require (
	...
	k8s.io/pod-security-admission v0.31.13
...
require (
	...
	k8s.io/cloud-provider v0.31.13 // indirect
	...
	k8s.io/csi-translation-lib v0.31.13 // indirect
	k8s.io/dynamic-resource-allocation v0.31.13 // indirect
...
replace (
	...
	k8s.io/component-helpers => k8s.io/component-helpers v0.31.13
	k8s.io/controller-manager => k8s.io/controller-manager v0.31.13
	k8s.io/cri-api => k8s.io/cri-api v0.31.13
	k8s.io/cri-client => k8s.io/cri-client v0.31.13
